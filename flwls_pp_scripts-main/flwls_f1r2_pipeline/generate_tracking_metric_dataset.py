...
def gen_dataset(gizmo_path = '/Volumes/f1r2/pipeline/vfx/nuke/gizmos/TrackingMetric_flw.gizmo'):
    ...
    node.setInput(1, plate)

    # connect facetracker camera
    node.setInput(0, facetracker_cam)
    ...
    #unwrap
    node['output_style'].setValue('unwrap')
    ...
    #calculations
    node['calculate_tracking_error'].execute()
    #render
    ...
    print("Done")
    print('-'*60)
    return (node['mean_track_error'].value(), node['max_track_error'].value())
...
if __name__== "__main__":
    ...
    gen_dataset(gizmo_path = '/Volumes/f1r2/pipeline/vfx/nuke/gizmos/TrackingMetric_flw.gizmo')
